...
if (isset($_POST['login'])) {
    ...
    if (count($error) == 0) {
        $querry = "SELECT * FROM patients WHERE username='$username' AND password='$password'";
    ...
    <div class="container">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h4 class="text-center">Patients Login</h4>
                        <div>
                            <?php echo $show; ?>
                        </div>
                    <form method="POST" class="my-1">
                        ...
                        <p>Don't Have an account? <a href="patients_create.php">Create Now!</a></p>
                    </form>
                </div>
            </div>
        </div>
